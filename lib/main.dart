      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () =>
                ref.read(movieListProvider.notifier).refresh(),
          ),
        ],
      ),
      body: Column(
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth > 600) {
          //le agregue una griedview para una pantalla mas grandr
          return GridView.builder(
            ...
            itemBuilder: (ctx, i) => Card(child: Center(child: Text(movies[i].title))),
          );
        } else {
          //le puse listview para una pantalla mas chica
          return ListView.builder(
            padding: const EdgeInsets.all(8),
            itemCount: movies.length,
            itemBuilder: (ctx, i) => ListTile(title: Text(movies[i].title)),
          );
        }
      },
    );
